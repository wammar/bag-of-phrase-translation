...
#OOV_LOG_PROB = -15.
#NAIVE_DWL_DIR = 'data/zh-en_naive/'
...
#nn_dwl_vocab = 'data/nn_dwl/zh-en_n10_hid100_b50_r0.05_vocab'
#nn_dwl_param = 'data/nn_dwl/zh-en_n10_hid100_b50_r0.05.npz'
...
def nn_dwl(source, target):
    ...
    for srcWord in source.split():
         srcWord = normalize_word(unicode(srcWord, 'utf-8'))
    ...
    for word in target.split():
        ...
        if word in NN_DWL_TGT_VOCAB:
            sent_log_prob += math.log(y_pred[ NN_DWL_TGT_VOCAB[word] ]/(1 - y_pred[ NN_DWL_TGT_VOCAB[word] ]))
